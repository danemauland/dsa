...
class MinMaxStack {
    ...
    push(val) {
        ...
        if (!this.top) {
            this.top = newNode;
            this.bottom = newNode;
            this.mini = new Node(val);
            this.maxi = new Node(val);
        } else {
            const temp = this.top;
            this.top = newNode;
            this.top.next = temp;
            if (this.mini.value > val || this.maxi.value < val) {
    ...
    pop() {
        ...
        this.length--;
        if (temp.value === this.mini.value) {
            this.mini = this.mini.next;
        }
        if (temp.value === this.maxi.value) {
            this.maxi = this.maxi.next;
        }
        return temp;
    }
